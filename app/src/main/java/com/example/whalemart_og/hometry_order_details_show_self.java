...
public class hometry_order_details_show_self extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hometry_order_details_show_self);
        ...
        ///////////////////
        FirebaseDatabase.getInstance().getReference().child("User").child(shopid)
                .child("yourorders")
                .child(id)
...
//                        mobilenumber.setText(phone);
        ...
        deliverd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(hometry_order_details_show_self.this, MainActivity.class));
                finish();
            }
        });
